...
const App = () => {
  ...
  const enrichMissingCoreMetadataNow = async () => {
    try {
      ...
      const response = await authRequest<EnrichCoreMetadataResponse>("/books/enrich-core-metadata", {
        method: "POST",
        body: {
          limit: limitNumber,
          provider: importProvider
      ...
      setMessage(
        `Core metadata done (${response.meta.providerUsed}). Updated ${response.meta.updatedCount}/${response.meta.processed}, AI-generated ${response.meta.autoGeneratedCount}, failed ${response.meta.failedCount}.`
      );
                  ...
                  <section className="import-box" aria-labelledby="import-title">
                    ...
                    <div className="import-actions">
                      ...
                      <button
                        className="btn btn-outline"
                        type="button"
                        onClick={() => void enrichMissingCoreMetadataNow()}
                        disabled={enrichingCoreMetadata}
                      >
                        {enrichingCoreMetadata ? "Auto-filling..." : "Auto-fill rating/genre/covers"}
                      </button>
                    </div>
                  </section>
                )}
